...
<iframe src="/two-easy-engine/demos/text_geometry.html" width="100%" height="400px" style="border:1px solid #ccc;"></iframe>
...
<html lang="en">
  ...
  <body>
    <input type="text" placeholder="Enter text" value="Hello World" id="text" />
    ...
    <script type="module">
      ...
      // Create a text mesh
      const texture2D = new Two.Texture2D({
      ...
      const geometry = new Two.TextGeometry(input.value, {
        font: "32px arial",
        textAlign: "center",
        textBaseline: "middle",
        direction: "ltr",
